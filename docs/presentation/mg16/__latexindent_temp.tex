...
\begin{frame}
    ...
    \begin{column}{.45\textwidth}
        \begin{figure}
            \copyrightbox[r]{\includegraphics[width=\textwidth]{img/sdss_galaxy_map.jpg}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.35]{img/Spectrum.png}}{Source of the image.}
    \end{figure}
    \begin{equation}
...
\begin{frame}
    ...
    \copyrightbox[r]{\includegraphics[scale=0.25]{img/sdss_plot.png}}{Source of the image.}
    \end{figure}
    \begin{equation}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.15]{img/Random_Forest.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.35]{img/decision_tree_intuition.png}}{Source of the image.}
...
\begin{frame}
        \frametitle{ANN}
        \begin{figure}
            \copyrightbox[r]{\includegraphics[scale=0.3]{img/lit_survay.png}}{Source of the image.}
...
\begin{frame}
        ...
        \begin{figure}
\vspace*{-18mm}
            \copyrightbox[b]{\includegraphics[scale=0.37]{img/Litsurvey.png}}{Source of the image.}
\vspace*{-25mm}
\begin{equation}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.2]{img/SDSS_imaging_camera.jpg}}{Source of the image.}
        \copyrightbox[r]{\includegraphics[scale=0.5]{img/wavelengths.png}}{Source of the image.}
        \copyrightbox[b]{\includegraphics[scale=0.3]{img/sdss_data.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{ \includegraphics[scale=0.18]{img/redshiftug.png}}{Source of the image.}
        % \caption*{SDSS Data Sample}
    \end{figure}
    \end{frame}
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{ \includegraphics[scale=0.71]{img/Gal_distr.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.25]{img/decision_tree.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.4]{img/overfiting_tree.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.6]{img/Tree_Result.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[b]{\includegraphics[scale=0.36]{img/Random_Forest_schematic.png}}{Source of the image.}
    \end{figure}
    \end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.6]{img/Forest_Result.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.60]{img/train-val.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.60]{img/deltaZ.png}}{Source of the image.}
...
\begin{frame}
    ...
    \begin{table}[ht]\
        ...
        Median Diff &  0.017 & 0.017  \\ [1ex] % [1ex] adds vertical space
        \hline %inserts single line
        \\
        \end{tabular}
        \end{table}       
