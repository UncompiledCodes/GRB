...
\begin{frame}
    ...
    \begin{figure}
        \copyrightbox[r]{\includegraphics[scale=0.60]{img/train-val-by-depth.png}}{}
...
\begin{frame}
    ...
    \begin{table}[ht]\
        ...
        Median Diff &  0.017 & 0.017  \\ % [1ex] adds vertical space
        $\overline{\Delta Z_{\text {norm}}}$ &  0.016 & 0.001  \\ [1ex] % [1ex] adds vertical space
        \hline %inserts single line
        \\
        \end{tabular}
        \end{table}
